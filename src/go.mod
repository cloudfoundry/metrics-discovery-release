...
require (
	...
	code.cloudfoundry.org/loggregator-agent-release/src v0.0.0-20240809083052-cfed89abb409
...
require (
	code.cloudfoundry.org/go-batching v0.0.0-20240730230425-f1661a61b989 // indirect
